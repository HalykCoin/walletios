...
class TransactionsFooterView: UIView {
    ...
    lazy var sendButton: Button = {
        ...
        sendButton.setTitleColor(Colors.lightWhite, for: .highlighted)
    ...
    lazy var requestButton: Button = {
        ...
        requestButton.setTitleColor(Colors.lightWhite, for: .highlighted)
        requestButton.titleLabel?.font = UIFont.systemFont(ofSize: 17, weight: UIFont.Weight.medium)
        requestButton.setTitle(NSLocalizedString("Generic.Receive", value: "Receive", comment: ""), for: .normal)
